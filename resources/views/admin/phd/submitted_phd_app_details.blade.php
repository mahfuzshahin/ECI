                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group {{ $errors->has('full_name') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="faculty_name" id="faculty_name" class="form-control" value="{{$phd_app_details->faculty->faculty_name}}" readonly>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group {{ $errors->has('department_id') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="department_name" id="department_name" class="form-control" value="{{$phd_app_details->department->department_name}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('full_name') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="user_name" id="user_name" class="form-control" value="{{$phd_app_details->user->name}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('father_name') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="father_name" id="father_name" class="form-control" value="{{$phd_app_details->father_name}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('mother_name') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="mother_name" id="mother_name" class="form-control" value="{{$phd_app_details->mother_name}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('spouse_name') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="spouse_name" id="spouse_name" class="form-control" value="{{$phd_app_details->spouse_name}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('date_of_birth') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="date_of_birth" name="date_of_birth" id="date_of_birth" class="form-control" value="{{$phd_app_details->date_of_birth}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('nationality') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="nationality" id="nationality" class="form-control" value="{{$phd_app_details->nationality}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('occupation') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="occupation" id="occupation" class="form-control" value="{{$phd_app_details->occupation}}" readonly>
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group {{ $errors->has('office_address') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="office_address" id="office_address" class="form-control" value="{{$phd_app_details->office_address}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('ssc_board') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="ssc_board" id="ssc_board" class="form-control" value="{{$phd_app_details->ssc_board}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('school_name') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="school_name" id="school_name" class="form-control" value="{{$phd_app_details->school_name}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('ssc_passing_year') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="ssc_passing_year" id="ssc_passing_year" class="form-control" value="{{$phd_app_details->ssc_passing_year}}" readonly>
                                                    {!! $errors->first('ssc_passing_year','<span class="help-block">:message</span>') !!}
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group {{ $errors->has('ssc_result') ? 'has-error' : '' }}">
                                                    <label for="ssc_result">SSC {{ ($phd_app_details->ssc_grade != NULL) ? 'Grade' : 'Division' }}</label> 
                                                    <input type="text" name="ssc_result" id="ssc_result" class="form-control" value="{{$phd_app_details->ssc_result}}" readonly>
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group {{ $errors->has('ssc_subject') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="ssc_subject" id="ssc_subject" class="form-control" value="{{$phd_app_details->ssc_subject}}" readonly>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group {{ $errors->has('ssc_group') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="ssc_subject" id="ssc_subject" class="form-control" value="{{$phd_app_details->ssc_group}}" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('hsc_board') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="hsc_board" id="hsc_board" class="form-control" value="{{$phd_app_details->hsc_board}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('college_name') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="college_name" id="college_name" class="form-control" value="{{$phd_app_details->college_name}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('hsc_passing_year') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="hsc_passing_year" id="hsc_passing_year" class="form-control" value="{{$phd_app_details->hsc_passing_year}}" readonly>
                                                    {!! $errors->first('hsc_passing_year','<span class="help-block">:message</span>') !!}
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group {{ $errors->has('hsc_result') ? 'has-error' : '' }}">
                                                    <label for="hsc_result">HSC {{ ($phd_app_details->hsc_grade != NULL) ? 'Grade' : 'Division' }}</label> 
                                                    <input type="text" name="hsc_result" id="hsc_result" class="form-control" value="{{$phd_app_details->hsc_result}}" readonly>
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group {{ $errors->has('phone_number') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="phone_number" id="phone_number" class="form-control" value="{{$phd_app_details->date_of_birth}}" readonly>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group {{ $errors->has('hsc_group') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="hsc_group" id="hsc_group" class="form-control" value="{{$phd_app_details->hsc_group}}" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('hons_university_name') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="hons_university_name" id="hons_university_name" class="form-control" value="{{$phd_app_details->hons_university_name}}" readonly>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group {{ $errors->has('hons_passing_year') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="hons_passing_year" id="hons_passing_year" class="form-control" value="{{$phd_app_details->hons_passing_year}}" readonly>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group {{ $errors->has('hons_result') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="hons_result" id="hons_result" class="form-control" value="{{$phd_app_details->hons_result}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('hons_subject_name') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="hons_subject_name" id="hons_subject_name" class="form-control" value="{{$phd_app_details->hons_subject_name}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('ms_university_name') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="ms_university_name" id="ms_university_name" class="form-control" value="{{$phd_app_details->ms_university_name}}" readonly>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group {{ $errors->has('ms_passing_year') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="ms_passing_year" id="ms_passing_year" class="form-control" value="{{$phd_app_details->ms_passing_year}}" readonly>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group {{ $errors->has('ms_result') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="ms_result" id="ms_result" class="form-control" value="{{$phd_app_details->ms_result}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('ms_subject_name') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="ms_subject_name" id="ms_subject_name" class="form-control" value="{{$phd_app_details->ms_subject_name}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('ms_university_name2') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="ms_university_name2" id="ms_university_name2" class="form-control" value="{{$phd_app_details->ms_university_name2}}" readonly>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group {{ $errors->has('ms_passing_year2') ? 'has-error' : '' }}">
                                                    <label for="phone_number">Passing Year</label> 
                                                    <input type="text" name="ms_passing_year2" id="ms_passing_year2" class="form-control" value="{{$phd_app_details->ms_passing_year2}}" readonly>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group {{ $errors->has('ms_result2') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="ms_result2" id="ms_result2" class="form-control" value="{{$phd_app_details->ms_result2}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('ms_subject_name2') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="ms_subject_name2" id="ms_subject_name2" class="form-control" value="{{$phd_app_details->ms_subject_name2}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('mphil_university') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="mphil_university" id="mphil_university" class="form-control" value="{{$phd_app_details->mphil_university}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('mphil_subject') ? 'has-error' : '' }}">
                                                    <label for="ms_subject_name2">Subject</label> 
                                                    <input type="text" name="mphil_subject" id="mphil_subject" class="form-control" value="{{$phd_app_details->mphil_subject}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('mphil_passing_year') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="mphil_passing_year" id="mphil_passing_year" class="form-control" value="{{$phd_app_details->mphil_passing_year}}" readonly>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group {{ $errors->has('phd_type') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="phd_type" id="phd_type" class="form-control" value="{{$phd_app_details->phd_type}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('reference1_name') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="reference1_name" id="reference1_name" class="form-control" value="{{$phd_app_details->reference1_name}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('reference1_designation') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="reference1_designation" id="reference1_designation" class="form-control" value="{{$phd_app_details->reference1_designation}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('reference1_affiliation') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="reference1_affiliation" id="reference1_affiliation" class="form-control" value="{{$phd_app_details->reference1_affiliation}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('reference1_phone') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="number" name="reference1_phone" id="reference1_phone" class="form-control" value="{{$phd_app_details->reference1_phone}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('reference1_email') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="reference1_email" id="reference1_email" class="form-control" value="{{$phd_app_details->reference1_email}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('reference1_address') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="reference1_address" id="reference1_address" class="form-control" value="{{$phd_app_details->reference1_address}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('reference1_name') ? 'has-error' : '' }}">
                                                    <label for="reference1_name">Referee Name</label> 
                                                    <input type="text" name="reference2_name" id="reference2_name" class="form-control" value="{{$phd_app_details->reference2_name}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('reference2_designation') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="reference2_designation" id="reference2_designation" class="form-control" value="{{$phd_app_details->reference2_designation}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('reference2_affiliation') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="reference2_affiliation" id="reference2_affiliation" class="form-control" value="{{$phd_app_details->reference2_affiliation}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('reference2_phone') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="number" name="reference2_phone" id="reference2_phone" class="form-control" value="{{$phd_app_details->reference2_phone}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('reference2_email') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="reference2_email" id="reference2_email" class="form-control" value="{{$phd_app_details->reference2_email}}" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group {{ $errors->has('reference2_address') ? 'has-error' : '' }}">
                                                    ...
                                                    <input type="text" name="reference2_address" id="reference2_address" class="form-control" value="{{$phd_app_details->reference2_address}}" readonly>
                                ...
                                <div class="box-header with-border">
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">    
                                            ...
                                            <input type="text" name="present_address" id="status" class="form-control" value="{{$phd_app_details->present_address}}" readonly/>
                                        </div>
                                        <div class="form-group">    
                                            <label for="status">Permanent Address</label>                    
                                    
                                            <input type="text" name="status" id="status" class="form-control" value="{{$phd_app_details->permanent_address}}" readonly/>
                                        </div>
                                        <div class="form-group">    
